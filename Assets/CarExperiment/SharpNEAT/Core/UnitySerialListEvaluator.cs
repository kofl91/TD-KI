...
{
    class UnitySerialListEvaluator<TGenome, TPhenome> : IGenomeListEvaluator<TGenome>
        ...
        where TPhenome : class
    {
        ...
        /// </summary>
        public UnitySerialListEvaluator(IGenomeDecoder<TGenome, TPhenome> genomeDecoder,
            ...
            for (int i = 0; i < _optimizer.Trials; i++)
            {
                ...
                foreach (TGenome genome in genomeList)
                {
                    ...
                    else
                    {
                        ...
                        Utility.Log("Population Member " + ++popCounter + " with fitness : " + fitnessInfo._fitness);
                        fitnessDict[genome][i] = fitnessInfo;
                        double fitness = 0;

                        for (int j = 0; j < _optimizer.Trials; j++)
                        {

                            fitness += fitnessDict[genome][j]._fitness;
